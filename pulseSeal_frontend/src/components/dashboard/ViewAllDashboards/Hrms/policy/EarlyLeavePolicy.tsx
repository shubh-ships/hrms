// components/policy/EarlyLeavePolicy.tsx
"use client";
...
import { Plus, Trash2, Save, Power, UserX, DollarSign } from "lucide-react";
import { toast } from "sonner";
import type { PenliteRule, DeductionRule, CreatePolicyData } from "@/features/policySlice/policeSlice";

const EarlyLeavePolicyComponent = () => {
  const dispatch = useAppDispatch();
  const policy = useAppSelector(selectPolicyByName("early_leave"));
  ...
  const handleSave = async () => {
    try {
      ...
      toast.success("Early leave policy saved successfully!");
    } catch (error: any) {
  ...
  return (
    <div className="space-y-6">
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription>
                Configure deduction rules for early departures
              </CardDescription>
            </div>
      ...
      <Card>
        <CardHeader>
          <div className="flex items-center justify-between">
            <CardTitle>Early Leave Rules</CardTitle>
        ...
        <CardContent>
          <div className="space-y-6">
            {formData.penliteRules.map((rule, ruleIndex) => (
              <Card key={ruleIndex} className="border-l-4 border-l-red-500">
                <CardHeader>
                  <div className="flex items-center justify-between">
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    {rule.ruleType !== "salary_deduction" && (
                      <>
                        <div className="space-y-2">
                          <Label>Early Hours Threshold</Label>
                          <Input
                            type="number"
                            min="0"
                        ...
                        <div className="space-y-2">
                          <Label>Early Minutes Threshold</Label>
                          <Input
                            type="number"
                            min="0"
                  ...
                  <div className="space-y-4">
                    ...
                    {rule.occurrence.isActive && (
                      <div className="grid grid-cols-2 gap-4">
                        ...
                        <div className="space-y-2">
                          <Label>Or Total Hours</Label>
                          <Input
                            type="number"
                            min="0"
                            placeholder="Total early hours"
            ...
            {formData.penliteRules.length === 0 && (
              <div className="text-center py-8 text-muted-foreground">
                ...
                <p>No early leave rules configured</p>
...
export default EarlyLeavePolicyComponent;