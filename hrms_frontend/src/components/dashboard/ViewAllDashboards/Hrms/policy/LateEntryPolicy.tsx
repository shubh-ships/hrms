// components/policy/LateEntryPolicy.tsx
"use client";
...
import { Plus, Trash2, Save, Power, Clock, DollarSign } from "lucide-react";
import { toast } from "sonner";
import type { PenliteRule, DeductionRule, CreatePolicyData } from "@/features/policySlice/policeSlice";

const LateEntryPolicyComponent = () => {
  const dispatch = useAppDispatch();
  const policy = useAppSelector(selectPolicyByName("late_entry"));
  ...
  const handleSave = async () => {
    try {
      ...
      toast.success("Late entry policy saved successfully!");
    } catch (error: any) {
  ...
  return (
    <div className="space-y-6">
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription>
                Configure deduction rules for late arrivals
              </CardDescription>
            </div>
      ...
      <Card>
        <CardHeader>
          <div className="flex items-center justify-between">
            <CardTitle>Late Entry Rules</CardTitle>
        ...
        <CardContent>
          <div className="space-y-6">
            {formData.penliteRules.map((rule, ruleIndex) => (
              <Card key={ruleIndex} className="border-l-4 border-l-orange-500">
                <CardHeader>
                  <div className="flex items-center justify-between">
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    {rule.ruleType !== "salary_deduction" && (
                      <>
                        <div className="space-y-2">
                          <Label>Late Hours Threshold</Label>
                          <Input
                            type="number"
                            min="0"
            ...
            {formData.penliteRules.length === 0 && (
              <div className="text-center py-8 text-muted-foreground">
                ...
                <p>No late entry rules configured</p>
...
export default LateEntryPolicyComponent;