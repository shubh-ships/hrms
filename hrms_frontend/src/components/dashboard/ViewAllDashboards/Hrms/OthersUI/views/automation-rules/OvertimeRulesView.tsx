...
const API_TYPE = "overtime";
const INCLUDE_CALC_TYPE = true;
const RULE_TITLE = "Overtime Rules";
const RULE_DESC = "Automate overtime for employees who are working extra after their shift hours";
...
export default function OvertimeRulesView() {
