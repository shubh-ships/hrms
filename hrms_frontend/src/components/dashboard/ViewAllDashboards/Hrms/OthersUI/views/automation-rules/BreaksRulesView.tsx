...
const API_TYPE = "break";
const RULE_TITLE = "Breaks Rules";
const RULE_DESC = "Automate break rules for employees taking breaks more than the allotted time";
...
export default function BreaksRulesView() {
      ...
      <div className="flex flex-col gap-6">
        <div className="space-y-3 pb-4">
          <label className="flex items-center gap-2 cursor-pointer w-fit">
            ...
            <span className="text-[13px] font-medium text-slate-700">Deduct salary if break exceeds by more than</span>
          </label>
          {deductSalary && (
        ...
        <div className="space-y-3 pb-4">
          <label className="flex items-center gap-2 cursor-pointer w-fit">
            ...
            <span className="text-[13px] font-medium text-slate-700">Deduct half day salary if break exceeds by more than</span>
          </label>
          {deductHalfDay && (
        ...
        <div className="space-y-3 border-b border-gray-100 pb-8">
          <label className="flex items-center gap-2 cursor-pointer w-fit">
            ...
            <span className="text-[13px] font-medium text-slate-700">Deduct full day salary if break exceeds by more than</span>
          </label>
          {deductFullDay && (
            <div className="bg-[#F8F9FA] p-5 rounded-xl border border-gray-100 flex flex-col gap-4">
              <div>
        ...
        <div className="pt-2 flex items-center gap-3">
          ...
          <span className="text-[13px] font-medium text-slate-600">Include deductions from start of shift</span>
        </div>
      </div>
      <div className="h-24" />
