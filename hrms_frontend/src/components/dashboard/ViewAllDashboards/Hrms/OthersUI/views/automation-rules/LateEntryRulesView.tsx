...
const API_TYPE = "late_fine";
const RULE_TITLE = "Late Entry Rules";
const RULE_DESC = "Automate late fine for employees who are coming late to work";
...
export default function LateEntryRulesView() {
